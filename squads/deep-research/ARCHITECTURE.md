...
```
  ...
  |  (input) |    | research-chief|    |  Diagnostic  |    |  Execution   |
  ...
  |  (output)|    | research-chief|    |  (sequential)|    |  results     |
...
|---|-------|----------|------|----------|--------|
| 1 | Query Intake | research-chief | Single | Immediate | Classified query + UC assignment |
| 2 | Classification | research-chief | Single | Immediate | Use case (UC-001~004) + agent selection |
...
| 6 | Synthesis | research-chief | Single | Post-QA | Integrated findings report |
| 7 | Report | research-chief | Single | Final | Structured deliverable |
...
```
  Tier 1 Results (aggregated by research-chief)
      |
      v
  ┌───────────────────────────────────────────────────┐
  ...
  └─────────────────────┬─────────────────────────────┘
              ...
              (returned to research-chief for synthesis)
```
...
The research-chief classifies incoming queries into one of four use cases. Classification determines which Tier 1 agents are activated.
...
```
research-chief applies this decision tree:
...
| Max retries | 2 (then escalate to research-chief) |
...
The research-chief uses a multi-step routing algorithm to transform raw queries into fully-orchestrated pipeline runs.
...
|------|---------|---------|------|
| Exa | Web search with AI-powered results | Higgins, Cochrane, Gilad, research-chief | Evidence gathering, source discovery |
