...
- **Escopo de especialista:** atuar apenas dentro do domínio do agente e herdar decisões MDSDC/workspace do chief/orquestrador do squad quando a tarefa atravessar múltiplos layers ou múltiplas BUs.
